...
export default function WorkExperience() {
    return (
        <div className="bg-white print:bg-white rounded-lg p-6 print:p-4">
            <h2 className="text-2xl font-bold text-gray-800 print:text-black mb-4 border-b pb-2 print:border-b-black">工作经历</h2>
            <div className="space-y-6">
                <div>
                    <div className="flex items-center justify-between mb-2">
                        <h3 className="text-xl font-medium text-gray-900 print:text-black">普瑞纯证医疗科技（广州）有限公司-数据分析师 IT部</h3>
                        <p className="text-sm text-gray-600 print:text-gray-700">2021.10 - 至今</p>
                    </div>
                ...
                <div>
                    <div className="flex items-center justify-between mb-2">
                        <h3 className="text-xl font-medium text-gray-900 print:text-black">鲤想科技有限公司 - 数据挖掘工程师 IT部</h3>
                        <p className="text-sm text-gray-600 print:text-gray-700">2020.08 - 2021.10</p>
                    </div>
                    <ul className="space-y-2 print:space-y-1">
                ...
                <div>
                    <div className="flex items-center justify-between mb-2">
                        <h3 className="text-xl font-medium text-gray-900 print:text-black">广州零壹沃土互联网金融信息服务有限公司 - 数据分析师 产品部</h3>
                        <p className="text-sm text-gray-600 print:text-gray-700">2018.08 - 2020.07</p>
                    </div>
                    <ul className="space-y-2 print:space-y-1">
